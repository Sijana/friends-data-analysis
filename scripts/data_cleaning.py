...
df_ratings = pd.read_csv("data/friends_episodes_data.csv", encoding='latin-1')
df_ratings["Episode_Title"] = df_ratings["Episode_Title"].str.lower()
df_episodes = pd.read_csv("data/friends_episodes_numbers.csv")
...
df.to_csv("output/friends_episode_ratings.csv", index=False)